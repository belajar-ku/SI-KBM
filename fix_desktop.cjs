...
const str = `<div className="flex items-center gap-4 text-xs font-bold text-slate-500 dark:text-slate-400">`;
if (code.indexOf(str) < code.indexOf(`/* DESKTOP TOP BAR */`)) {
    code = code.replace(str, ""); // remove the first stray one
}
