...
const targetHeader = `        {/* Flashcard Profile */}
...
const replacementHeader = `<div className="bg-[#1281ff] dark:bg-blue-900 rounded-3xl p-6 md:p-8 text-white shadow-xl shadow-blue-200/50 dark:shadow-none relative overflow-hidden">
