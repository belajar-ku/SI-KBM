...
import {  ArrowLeft, ArrowRight, Check, Send, Sparkles, BookOpen, Clock, ToggleLeft, ToggleRight, Loader2, Edit3, XCircle, CheckCircle2, MessageSquare, History, ClipboardCheck, X, ClipboardList, BookOpenCheck, Ban, ChevronRight, Plus, Trash2, ChevronDown, CheckSquare, Square, Gavel, Lock , BookOpenText } from 'lucide-react';
...
const JurnalForm: React.FC = () => {
  ...
  const fetchInitData = async () => {
    ...
    try {
        ...
        const [schedulesRes, settingsRes, activityRes] = await Promise.all([
  ...
  const renderStep1 = () => (
    <div className="bg-white dark:bg-slate-800 rounded-3xl p-4 md:p-6 shadow-sm border border-slate-200 dark:border-slate-700 animate-fade-in">
      ...
      <div className="flex justify-end mt-8 pt-6 border-t border-slate-100">
        <button disabled={!formData.kelas || loading} onClick={handleNext} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-blue-200 disabled:opacity-50 disabled:shadow-none transition-all">
