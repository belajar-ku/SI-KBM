                    ...
                    <div className="p-6">
                        ...
                        {modalType === 'masuk' && (
                             <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <label className={`flex-1 text-center py-3 rounded-xl cursor-pointer border font-bold text-sm transition-all ${formData.gender === 'L' ? 'bg-blue-100 border-blue-300 text-blue-700' : 'border-slate-200 text-slate-500 hover:bg-slate-50'}`}><input type="radio" className="hidden" name="gender" value="L" checked={formData.gender === 'L'} onChange={() => setFormData({...formData, gender: 'L'})} /> L</label>
                                ...
                                <button onClick={handleSaveMasuk} disabled={saving} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 mt-4 shadow-lg shadow-blue-200 disabled:opacity-50 transition-all">{saving ? <Loader2 className="animate-spin" /> : <Save size={20} />} Simpan Data</button>
                            </div>
                        )}
